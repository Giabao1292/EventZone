...
const ReviewSection = ({ showingTimeId, canReview, organizerId, onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setContent("");
            setRating(0);
            await fetchReviews(); // phải gọi lại fetchReviews ngay sau submit
        } catch {
        ...
        <div className="fixed inset-0 z-[1000] bg-black/40 flex items-center justify-center">
            ...
            >
                ...
                <button
                    ...
                    onClick={onClose}
                    aria-label="Đóng"
                    className="absolute top-5 right-5 z-50 p-1 rounded-full text-gray-400 hover:bg-gray-200"
                >
                    <X className="w-6 h-6" />
                </button>
                <div
            ...
            <span className="text-[36px] font-bold text-yellow-400">
              {avgRating || "-"}
            </span>
                    ...
                    >
                        {loading ? (
                            ...
                            filteredReviews.map((r, idx) => (
                                <div
                                    key={r.reviewId}
                                    className="bg-gray-50 rounded-xl px-7 py-5"
                                >
                                    {/* User row */}
